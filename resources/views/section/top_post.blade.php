    <div class="featured-big-wrapper">
        ...
        <!-- BEGIN LOOP (large featured story) -->
            <div class="featured-stories-wrapper featured-large">
                ...
                <div class="featured-stories-inner" style="background-image:url({{ $top_posts[0]->banner ?? asset('assets/images/default_banner.jpg') }});">
    ...
    <!-- BEGIN LOOP (small featured stories) -->
        <div class="featured-stories-wrapper">
            ...
            <div class="featured-stories-inner" style="background-image:url({{ $top_posts[1]->banner ?? asset('assets/images/default_banner.jpg') }});">
                <div class="featured-stories-bg-gradient">
        ...
        <div class="featured-stories-wrapper">
            ...
            <div class="featured-stories-inner" style="background-image:url({{ $top_posts[2]->banner ?? asset('assets/images/default_banner.jpg') }});">
                <div class="featured-stories-bg-gradient">
