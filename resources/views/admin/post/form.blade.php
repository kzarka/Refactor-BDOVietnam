<form action="{{ isset($post) ? route('admin.post.update', $post->id) : route('admin.post.store') }}" method="POST" class="validate" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label for="excert">Ảnh <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ảnh banner hiển thị ngoài trang chủ"></i></label><br>
	...
	<div class="form-group">
		<label for="content">Nội Dung <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Có thể copy paste link ảnh, upload trực tiếp không được hỗ trợ"></i></label>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				<label for="city">Chuyên Mục <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Chọn một chuyên mục cha"></i></label>
			...
			<div class="form-group">
				<label for="street">Chuyên Mục Con <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Chọn một hoặc nhiều chuyên mục con"></i></label>
		...
		<div class="col-sm-6">
			<div class="form-group ">
				<label for="postal-code">Slug <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Slug được tạo tự động"></i></label>
			...
			<div class="form-group col-sm-4 is-submitted">
				<label for="postal-code">Public <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Chọn hiển thị bài viết công khai"></i></label><br>
	...
	<div class="form-group">
		<label for="city">Gắn thẻ</label> <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tối thiểu 2 ký tự. Tag quá ngắn hoặc quá dài sẽ bị lược bỏ"></i>
