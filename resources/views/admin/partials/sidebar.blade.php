        ...
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" href="#">
                    <i class="nav-icon fa fa-newspaper-o"></i> Bài viết
                </a>
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.post.index') }}">
                        <i class="nav-icon fa fa-book"></i> Bài viết</a>
                    </li>
                    <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <i class="nav-icon fa fa-comments"></i> Bình luận</a>
            </li>
            @if(Auth::user()->authorizeRoles([ROLE_ADMIN, ROLE_MOD]))
            <li class="nav-title">Extras</li>
            <li class="nav-item nav-dropdown">
                <a class="nav-link nav-dropdown-toggle" href="#">
                    <i class="nav-icon fa fa-newspaper-o"></i> Quản lý Post
                </a>
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.post.approve') }}">
                            <i class="nav-icon fa fa-flash"></i> Phê duyệt @if($unapproved_post_count)<span class="badge badge-danger" title="{{ $unapproved_post_count }} post(s) need to be approve">{{ $unapproved_post_count }}</span>@endif
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.post.manage') }}">
                            <i class="nav-icon fa fa-calendar-check-o"></i> Quản lý
                        </a>
                    </li>
                </ul>
            </li>
