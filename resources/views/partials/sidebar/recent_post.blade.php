                ...
                <li>
                    ...
                    <a class="latest-widget" href="{{ $recent_post->url }}">
                        ...
                        <div class="featured-image">
                            <img width="200" height="200" src="{{ $recent_post->thumbnail }}" class="attachment-widget-thumb size-widget-thumb wp-post-image" alt="" sizes="(max-width: 200px) 100vw, 200px" style="object-fit: cover;" />
                        </div>
                        <!-- END featured image -->
                        <!-- BEGIN title + date -->
